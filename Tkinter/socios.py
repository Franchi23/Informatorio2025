...
class Socios(tk.Frame):
    ...
    def agregar_socios(self):                      # Funcion para pasar los text a la grilla
        ...
        if (nombre == "") or (domicilio =="") or (telefono ==""):
            ...
            self.tree.insert("",tk.END, values=("1",nrodoc,nombre,domicilio,telefono,mail,sexo,fecha))
            self.limpiar_text()
...
#           GRILLA 
        ...
        #BOTONES
        btn_agregar = tk.Button(lblframe1,text="Agregar ",bg="lightgrey",font="sans 12 bold", command=self.agregar_socios)
